            ...
            <div class="outer-signup-form">
                <section>
                    <form action="{{ route('signup') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                        @csrf <!-- CSRF保護 -->
                        <p><input type="text" name="name" placeholder="本名を入力" autocomplete="off" style="width:250px; height:30px;"></P>
                        <p><input type="text" name="nickname" placeholder="ニックネームを入力" autocomplete="off" style="width:250px; height:30px; margin-top:10px;"></P>
                        <p><input type="email" name="email" placeholder="メールアドレスを入力" autocomplete="off" style="width:250px; height:30px; margin-top:10px;"></p>
                        <p><input type="password" name="password" placeholder="パスワード(8文字以上)を入力" autocomplete="off" style="width:250px; height:30px; margin-top:10px;"></p>
